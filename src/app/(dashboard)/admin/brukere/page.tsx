...
export default function AdminBrukerePage() {
  ...
  const handleAdd = () => {
    ...
    const user: UserItem = {
      ...
      epost: newUser.epost,
      rolle: newUser.rolle,
      sentral_ids: newUser.rolle === 'operator' ? newUser.sentral_ids : [],
      aktiv: true,
  ...
  const handleSaveEdit = () => {
    ...
    setBrukere(brukere.map(u => u.id === editUser.id ? {
      ...
      sentral_ids: editForm.rolle === 'operator' ? editForm.sentral_ids : [],
    } : u))
    setEditUser(null)
  }
    ...
    <div className="space-y-4">
      ...
      {values.rolle === 'operator' && (
        <div>
          ...
          <p className="text-xs text-gray-500 mb-2">Velg en eller flere sentraler (inkl. makkersentraler)</p>
